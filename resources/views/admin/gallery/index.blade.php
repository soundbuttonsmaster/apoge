                                                ...
                                                @if (!empty($galleryList))
                                                    @foreach ($galleryList as $key => $item)
                                                        <tr>
                                                            <td>{{ $key + 1 }}</td>
                                                            <td><img
                                                                    src="{{ asset('uploads/gallery/small/' . $item->image) }}">
                                                            </td>

                                                            <td>{{ $item->status == 1 ? 'Active' : 'Deactive' }}</td>
                                                            <td><a href="{{ route('admin.gallery.edit', $item->id) }}"><i
                                                                        class="far fa-edit"></i></a></td>
                                                            <td><a href="{{ route('admin.gallery.delete', $item->id) }}"
