...
@section('main-content')
    <main>
        <div class="container-fluid">
            <h2 class="mb-4"> Find a dealer</h2>
                ...
                <div class="col-md-12">
                    <div class="card my-4">
                        <div class="card-header">
                            ...
                            Find a Dealer View
                                   <a href="{{ route('admin.find_a_dealer_export') }}" class="btn btn-primary"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @if (!empty($findDelaerList))
                                            @foreach ($findDelaerList as $key => $item)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                ...
                                                <td><a href="{{ route('admin.delete_find_a_dealer', $item->id) }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt"></i></a></td>
                                            </tr>    
                                            @endforeach
                                        @endif
