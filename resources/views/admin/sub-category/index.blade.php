                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h6 class="card-title">Add Sub Category Form</h6>
                        ...
                        <div class="card-body" id="demo">
                            <form action="{{ route('admin.sub_category.store') }}" method="POST" data-parsley-validate>
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="inputName">Add Sub Category <span id="reqioredf">*</span></label>
                                                ...
                                                @if (!empty($subcategoryList))
                                                    @foreach ($subcategoryList as $key => $item)
                                                        <tr>
                                                            ...
                                                            <td><a
                                                                    href="{{ route('admin.sub_category.edit', $item->id) }}"><i
                                                                        class="far fa-edit"></i></a></td>
                                                            <td><a href="{{ route('admin.sub_category.delete', $item->id) }}"
