                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body" id="demo">
                            <form action="{{ route('admin.session.store') }}" method="POST" data-parsley-validate>
                                @csrf
                                <div class="row">
                                                ...
                                                @if (!empty($sessionList))
                                                    @foreach ($sessionList as $key => $item)
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ route('admin.session.edit', $item->id) }}"><i
                                                                        class="far fa-edit"></i></a></td>
                                                            <td><a href="{{ route('admin.session.delete', $item->id) }}"
