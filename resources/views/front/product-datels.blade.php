                                ...
                                <div id="tab-1" class="tab-content xzoom-thumbs">
                                    @if (!empty($productImages))
                                        @foreach ($productImages as $item)
                                            <a href="{{ asset('uploads/products/large/' . $item) }}"><img class="xzoom-gallery5"
                                                    width="117" src="{{ asset('uploads/products/thumb/' . $item) }}"
                ...
                <div class="col-md-6">
                    ...
                    <div class="content-inner">
                        ...
                        <div class="wrap-quantity">
                            <a href="{{ route('home.contact_us') }}"> <button type="submit" class="tf-btn btn-add-cart">
                                    <span class="text-style"> Get a Quote </span> <span class="icon"> <i
