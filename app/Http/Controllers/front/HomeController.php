...
class HomeController extends Controller
{
    ...
    public function AboutUs()
    {
        ...
        $meta_description = "Learn about Apogee Agrotech - India's leading manufacturer of Laser Land Leveller and Laser Land Leveler equipment. Discover our journey in precision agriculture and commitment to quality.";
    ...
    public function ProductListingCategory($category_slug)
    {
        ...
        $meta_description = !empty($category->meta_description) ? $category->meta_description : 'Explore ' . $category_name . ' products by Apogee Agrotech. Best quality Laser Land Leveller equipment for precision agriculture. Get best prices in India.';
    ...
    public function Blog()
    {
        ...
        return view('front.media.blog', compact('blog', 'meta_title', 'meta_keywords', 'meta_description', 'schema_type', 'ogImage'));
    }
    ...
    public function Contactus()
    {
        ...
        $meta_description = "Contact Apogee Agrotech for Laser Land Leveller inquiries, product information, dealer opportunities, and support. Email sales@apogeeagrotech.com. Located in Hapur, UP, India.";
        $schema_type = 'ContactPage';
